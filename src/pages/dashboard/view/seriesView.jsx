...
export default function SeriesView() {
  const [series, setSeries] = useState([
    {
      id: 1,
      code: "A",
      label: "Série A (Littéraire)",
      description: "Orientation générale littéraire",
    },
    {
      id: 2,
      code: "B",
      label: "Série B (Littéraire avancée)",
      description: "Orientation avancée littéraire",
    },
    {
      id: 3,
      code: "C",
      label: "Série C (Scientifique)",
      description: "Orientation générale scientifique",
    },
    {
      id: 4,
      code: "D",
      label: "Série D (Scientifique avancée)",
      description: "Orientation avancée scientifique",
    },
  ]);
  ...
  const handleSave = () => {
    ...
    if (editingId) {
      setSeries(
        series.map((s) => (s.id === editingId ? { ...s, ...formData } : s)),
      );
      showToast('Série modifiée avec succès', 'success');
    } else {
      setSeries([...series, { id: Date.now(), ...formData }]);
