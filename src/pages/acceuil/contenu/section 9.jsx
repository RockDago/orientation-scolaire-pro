...
const CHOIX_ETUDES = [
  "Faire des études courtes (moins de 3 ans)",
  "Faire des études longues (plus de 3 ans)",
];
      ...
      <div className="relative z-10 flex flex-col h-full w-full px-5 sm:px-8 pt-5 pb-4">
        ...
        <div className="flex-1 overflow-y-auto py-2 scrollbar-hide">
          ...
          <div className="flex flex-col items-start w-full max-w-lg">
            ...
            {/* Options en pills alignées à gauche */}
        ...
        <div className="flex flex-col items-center gap-4 mt-4">
          {/* Bouton Voir les résultats - style comme section 6 */}
          <button
            onClick={handleVoir}
            disabled={!choix}
